  ...
  return (
    <>
      <div className="mt-10 md:mt-20">
        ...
        <p className="text-xl md:text-3xl text-[#1F306A]">ช่องทางการติดต่อ</p>
        <div className="flex flex-wrap gap-10">
          <div className="text-sm md:text-base">
            <div className="border-b py-2">
              <p className=" text-amber-600 font-semibold text-base md:text-xl mb-2">
              ...
              <p>
                โทร: &nbsp;
                {/* <span>061-019-8815 ( อ.พรพิมล ) </span> */}
            ...
            <div className="mt-3 border-b pb-2">
              ...
              <p className="flex items-center">
                ...
                <a href="https://www.facebook.com/TeacherPornpimol">
                  &nbsp;FB: &nbsp;teacher Pornpimol
                </a>
              </p>
            </div>
          </div>
        ...
        <div className="mt-5 ">
          <iframe
            className="md:w-full h-full md:h-96 rounded-lg border-t-2 border-blue-300 drop-shadow-lg"
