        ...
        <>
            ...
            <div>
                ...
                <div className="relative">
                    ...
                    <img className="w-full h-[100px] sm:h-[200px] md:h-[300px] lg:h-[300px] xl:h-[200px] mb-3 bg-gradient-to-r from-blue-900 via-yellow-500 to-blue-900" src="/img/event/111.png" alt="Event" />
