...
export default function SumCheck() {
  ...
  useEffect(() => {
    ...
    if (typeof idFromQuery === "string") {
      ...
      axios
        .get(`/api/registerForm/${idFromQuery}`)
        .then((response) => {
  ...
  return (
    <TheLayout>
      ...
      <div className='container mx-auto md:py-24 py-12'>
        ...
        <div className="bg-[#1F306A] w-full h-1  mb-7  "></div>
        <div className="">
          {/* ข้อมูลผู้สมัคร  */}
          <div className=" outline outline-1  drop-shadow-xl shadow-xl">
            ...
            <div className=" md:grid md:grid-cols-12 grid-cols-1 pb-2 pt-4 ">
              ...
              <div className=" col-span-2 my-2">
                <input
                  readOnly
                  defaultValue={formData.regIdpersonal}
                  name="regIdpersonal"
                  type="text"
              ...
              <div className="col-span-2 my-2">
                <input
                  readOnly
                  defaultValue={formData.regBirth}
                  name="regBirth"
                  type="date"
              ...
              <div className=" col-span-1 md:col-span-2  md:my-2">
                <input
                  readOnly
                  defaultValue={formData.regPrefix}
                  name="regPrefix"
                  className=" block w-full md:w-1/2 bg-gray-200 text-gray-700 border border-black rounded py-3 px-2  leading-tight focus:outline-none focus:bg-white"
                ></input>
              </div>
              ...
              <div className="col-span-2 my-2 md:ml-2">
                <input
                  readOnly
                  defaultValue={formData.regNation}
                  name="regNation"
                  type="text"
              ...
              <div className=" col-span-2 my-2">
                <input
                  readOnly
                  defaultValue={formData.regNameTh}
                  name="regNameTh"
                  type="text"
                  className="appearance-none block w-full bg-gray-200 text-gray-700 border border-black rounded py-3 px-4  leading-tight focus:outline-none focus:bg-white"
                />
              ...
              <div className="col-span-2 my-2">
                <input
                  readOnly
                  defaultValue={formData.regLastnameTh}
                  name="regLastnameTh"
                  type="text"
                  className="appearance-none block w-full bg-gray-200 text-gray-700 border border-black rounded py-3 px-4  leading-tight focus:outline-none focus:bg-white"
                />
              ...
              <div className=" col-span-2 my-2">
                <input
                  readOnly
                  defaultValue={formData.regNameEng}
                  name="regNameEng"
                  type="text"
                  className="appearance-none block w-full bg-gray-200 text-gray-700 border border-black rounded py-3 px-4  leading-tight focus:outline-none focus:bg-white"
                />
              ...
              <div className="col-span-2 my-2">
                <input
                  readOnly
                  defaultValue={formData.regLastnameEng}
                  name="regLastnameEng"
                  type="text"
                  className="appearance-none block w-full bg-gray-200 text-gray-700 border border-black rounded py-3 px-4  leading-tight focus:outline-none focus:bg-white"
                />
              ...
              <div className=" col-span-2 my-2">
                <input
                  readOnly
                  defaultValue={formData.regPhone}
                  name="regPhone"
                  type="text"
                  className="appearance-none block w-full bg-gray-200 text-gray-700 border border-black rounded py-3 px-4  leading-tight focus:outline-none focus:bg-white"
                />
              ...
              <div className="col-span-2 my-2 ">
                <input
                  readOnly
                  defaultValue={formData.regEmail}
                  name="regEmail"
                  type="email"
                  className="appearance-none block w-full bg-gray-200 text-gray-700 border border-black rounded py-3 px-4  leading-tight focus:outline-none focus:bg-white"
                />
              ...
              <div className="md:col-span-4 md:my-2 md:self-center md:flex md:justify-center flex items-center pb-4 md:pb-0 ">
                <img
                  src={`https://imagedelivery.net/QZ6TuL-3r02W7wQjQrv5DA/${formData.regImg}/public`}
                  alt="Profile Image"
                />
              </div>
            </div>
          ...
          <div className=" outline outline-1  drop-shadow-xl shadow-xl my-10 pb-2 ">
            ...
            <div className="md:grid md:grid-cols-12 grid-cols-1 pt-4 ">
              ...
              <div className=" col-span-6 my-2">
                <input
                  readOnly
                  defaultValue={formData.regoldSchool}
                  name="regoldSchool"
                  type="text"
                  className="appearance-none block w-full bg-gray-200 text-gray-700 border border-black rounded py-3 px-4  leading-tight focus:outline-none focus:bg-white"
                />
              ...
              <div className=" col-span-2 my-2">
                <input
                  readOnly
                  defaultValue={formData.regDegree}
                  name="regDegree"
                  className="  text-sm block w-full bg-gray-200 text-gray-700 border border-black rounded py-3 px-4  leading-tight focus:outline-none focus:bg-white"
                ></input>
              </div>
              <div className="col-start-6 col-end-8 md:text-right p-3 my-2 ">
          ...
          <div className=" outline outline-1  drop-shadow-xl shadow-xl my-10 pb-2 ">
            ...
            <div className="md:grid md:grid-cols-12 grid-cols-1 ">
              ...
              <div className=" col-span-2 my-2">
                <input
                  readOnly
                  defaultValue={formData.regFaculty}
                  name="regFaculty"
                  className="  text-sm block w-full bg-gray-200 text-gray-700 border border-black rounded py-3 px-4  leading-tight focus:outline-none focus:bg-white"
                ></input>
              </div>
              ...
              <div className="col-span-2 my-2">
                <input
                  readOnly
                  defaultValue={formData.regMajor}
                  name="regMajor"
                  className="  text-sm block w-full bg-gray-200 text-gray-700 border border-black rounded py-3 px-4  leading-tight focus:outline-none focus:bg-white"
                ></input>
              </div>
