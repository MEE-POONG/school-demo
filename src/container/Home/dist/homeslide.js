...
var HomeSlider = function () {
    ...
    return (react_1["default"].createElement("div", { className: "container mx-auto drop-shadow-xl" },
        react_1["default"].createElement(react_slick_1["default"], __assign({}, settings, { className: "no-slick-arrow" }), newsArray
            ...
            react_1["default"].createElement(link_1["default"], { key: news.id, href: "/news/" + news.id },
                react_1["default"].createElement("img", { className: "w-full h-full rounded-md", src: "https://imagedelivery.net/QZ6TuL-3r02W7wQjQrv5DA/" + news.promoteImg + "/700", alt: "" })))); }))));
};
