...
export const Menu: React.FC = () => {
    ...
    return (
        <div className="container m-auto my-6 flex justify-around flex-wrap">
            ...
            <Link href="/welfare" className="p-4 w-1/2  md:w-1/4 lg:w-1/6 flex my-2 justify-center drop-shadow-lg" data-aos="fade-up" data-aos-delay="100" data-aos-duration="100">
                <Card className="w-full p-4 bg-blue-400 hover:bg-yellow-800">
                    <Typography variant="small" color="white" className="font-normal uppercase text-center text-sm sm:text-base md:text-md lg:text-lg xl:text-1xl">
                        สวัสดิการ
                    </Typography>
            ...
            <Link href="/advisor" className="p-4 w-1/2  md:w-1/4 lg:w-1/6 flex my-2 justify-center drop-shadow-lg" data-aos="fade-up" data-aos-delay="200" data-aos-duration="100">
                <Card className="w-full p-4 bg-blue-400 hover:bg-yellow-800">
                    <Typography variant="small" color="white" className="font-normal uppercase text-center text-sm sm:text-base md:text-md lg:text-lg xl:text-1xl">
                        ปรึกษาเพิ่มเติม
                    </Typography>
            ...
            <Link href="/faculty" className="p-4 w-1/2  md:w-1/4 lg:w-1/6 flex my-2 justify-center drop-shadow-lg" data-aos="fade-up" data-aos-delay="300" data-aos-duration="100" >
                <Card className="w-full p-4 bg-blue-400 hover:bg-yellow-800">
                    <Typography variant="small" color="white" className="font-normal uppercase text-center text-sm sm:text-base md:text-md lg:text-lg xl:text-1xl">
                        คณะที่เปิดสอน
                    </Typography>
