...
var NewsAll = function () {
    var _a = react_2.useState([]), newsMenu = _a[0], setNewsMenu = _a[1];
    var _b = react_2.useState("News"), selectType = _b[0], setSelectType = _b[1];
    ...
    react_2.useEffect(function () {
        fetch('/api/news/type')
            ...
            .then(function (data) {
            console.log("type : ", data === null || data === void 0 ? void 0 : data.distinctNewsTypes);
            setNewsMenu(data === null || data === void 0 ? void 0 : data.distinctNewsTypes);
            setIsLoading(false);
    ...
    return (react_2["default"].createElement("div", { className: "container" },
        react_2["default"].createElement(react_1.Tabs, { id: "custom-animation", value: selectType },
            react_2["default"].createElement(react_1.TabsHeader, { className: "bg-blue-700 text-white flex-wrap md:flex-nowrap justify-center", indicatorProps: {
                ...
                } }, newsMenu.map(function (type) { return (react_2["default"].createElement(react_1.Tab, { key: type, value: type, className: "font-bold text-white w-1/2 md:w-full", onClick: function () { return setSelectType(type); } }, type)); })),
