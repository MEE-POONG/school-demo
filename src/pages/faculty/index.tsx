    ...
    <>
      ...
      <div className='container mx-auto'>
        ...
        <div className='flex justify-between'>
          <div><h1 className='text-4xl text-[#0000B8]'>คณะ/หลักสูตร</h1></div>
          <div>
            <button type="button" className="text-white bg-[#0000B8] hover:bg-[6CB4EE] focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">
              สมัครเรียน
            </button>
          </div>
        </div>
        ...
        <div className='flex columns-2 gap-8 mb-8'>
          ...
          <div>
            ...
            <div className='flex mt-3 mb-3'>
              <svg xmlns="http://www.w3.org/2000/svg" width="65" height="65" viewBox="0 0 24 24"><path fill="#1f306a" d="M22 21H2V3h2v16h2v-9h4v9h2V6h4v13h2v-5h4v7Z" /></svg>
              <div className='ml-2'>
                <h1 className='text-2xl text-[#0000B8]' >
                  คณะบริหารธุรกิจ
                </h1>
                <div>
                  <h1 className='text-2xl text-[#0000B8]'>Faculty of Business Administration</h1>
                </div>
              </div>
            </div>

            <ul className="list-disc list-inside text-[#536878] ml-3   ">
          ...
          <div>
            ...
            <div className='flex mt-3 mb-3'>
              <svg xmlns="http://www.w3.org/2000/svg" width="65" height="65" viewBox="0 0 24 24"><path fill="#1f306a" d="M5 21q-1.275 0-1.813-1.137t.263-2.113L9 11V5H8q-.425 0-.713-.288T7 4q0-.425.288-.713T8 3h8q.425 0 .713.288T17 4q0 .425-.288.713T16 5h-1v6l5.55 6.75q.8.975.263 2.113T19 21H5Zm0-2h14l-6-7.3V5h-2v6.7L5 19Zm7-7Z" /></svg>
              <div className='ml-2'>
                <h1 className='text-2xl text-[#0000B8]'>คณะวิทยาศาสตร์และเทคโนโลยี </h1>
                <div>
                  <h1 className='text-2xl text-[#0000B8]'>Faculty of Science and Technology</h1>
                </div>
              </div>
            </div>
