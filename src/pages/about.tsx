            ...
            <div className="container mx-auto mt-20 md:py-24 md:mt-24">
                ...
                <div className="shadow-xl px-8 py-3">
                    ...
                    <div className="md:mt-10 text-justify border-b-2 border-gray-500/30">
                        ...
                        <p className="mb-4 indent-5 md:indent-8 text-black text-xs md:text-base ">
                    ...
                    <div className="my-5 text-center border-b-2 border-gray-500/30 pb-5">
                        <p className="text-[#2797FF] text-base md:text-xl mb-5">สีของวิทยาลัยเทคโนโลยีพนมวันท์</p>
                        ...
                        <p className="text-[#80bfff] mr-2 text-xs md:text-base ">
                            น้ำเงิน
                            <span className="text-black text-xs md:text-base  indent-5 "
                            >
                                &nbsp;&nbsp;หมายถึง ความลุ่มลึก ความหนักแน่น มั่นคงในเชิง วิชาการ เปรียบ เสมือนน้ำทะเลสีน้ำเงิน
                            </span>
                        </p>

                        <p className="text-[#FFBF00] mr-2 text-xs md:text-base ">
                            เหลืองทอง
                            <span className="mb-10 text-black text-xs md:text-base  indent-5 "
                            >
