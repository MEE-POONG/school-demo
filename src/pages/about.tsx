        ...
        <RootLayout>
            ...
            <div className="grid md:grid-flow-col justify-center gap-3 md:gap-10 mt-6">
                ...
                <div className="text-center">
                    <div className="bg-white text-blue-900 p-3 rounded-full hover:bg-blue-900 hover:text-white border-2 border-blue-900">
                        <Link href=""><RiFilePaper2Line size={70} /></Link>
                    </div>
                ...
                <div className="text-center">
                    <div className="bg-white text-blue-900 p-3 rounded-full hover:bg-blue-900 hover:text-white border-2 border-blue-900">
                        <Link href=""><FaMoneyBill size={70} /></Link>
                    </div>
                ...
                <div className="text-center">
                    <div className="bg-white text-blue-900 p-3 rounded-full hover:bg-blue-900 hover:text-white border-2 border-blue-900">
                        <Link href=""><RiGraduationCapLine size={70} /></Link>
                    </div>
                ...
                <div className="text-center">
                    <div className="bg-white text-blue-900 p-3 rounded-full hover:bg-blue-900 hover:text-white border-2 border-blue-900">
                        <Link href=""><FaUserGraduate size={70} /></Link>
                    </div>
            ...
            <div className='container mx-auto py-5 md:py-24 text-blue-900'>
                ...
                <div className="flex justify-between ...">
                    <div className="order-last"><Link href="about">อ่านทั้งหมด</Link>
                    </div>
                    <div></div>
                </div>
