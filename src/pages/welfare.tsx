    ...
    <TheLayout>
        ...
        <div className="max-w-8xl container relative mx-auto">
          <div className="flex flex-wrap items-center">
            <div className="ml-auto mr-auto w-full px-4 text-center lg:w-8/12">
              <p className="mb-6 font-medium text-xl md:text-4xl text-white">
                สวัสดิการนักศึกษา
              </p>
            </div>
          </div>
      ...
      <div className="container mx-auto p-5 md:p-20 ">
        <div className="grid md:grid-cols-2 lg:grid-cols-3 justify-center gap-5">
          {/* 1 */}
          <div
            className="p-5 shadow-xl rounded-md text-center bg-white border-t-2 border-yellow-700"
            data-aos="zoom-in"
          >
            <img className="mx-auto" src="/icons/office.png" alt="" />
            <p className="text-base md:text-lg text-amber-500 font-semibold my-2">
              หอพักฟรี
            </p>
            <p className="text-left indent-6 text-xs md:text-sm">
              บริการหอพักนักศึกษา ฟรี 1 ปีการศึกษา
              ห้องพักแต่ละห้องมีสิ่งอำนวยความสะดวกให้นักศึกษาและหอพักอยู่ใต้การดูแลควบคุมของอาจารย์ประจำหอพัก
            </p>
          </div>
          {/* 2 */}
          <div
          ...
          >
            ...
            <p className="text-left indent-6 text-xs md:text-sm">
              ได้รับพิจารณาให้กู้ กยศ. หรือ กรอ. ตลอดจนจบการศึกษา
              โดยไม่ต้องสำรองจ่าย
            </p>
          </div>
          {/* 3 */}
          ...
          >
            ...
            <p className="text-left indent-6 text-xs md:text-sm">
              ศูนย์ระบบสารสนเทศเพื่อการเรียนรู้และห้องสมุดเพื่อให้นักศึกษาและคณะอาจารย์ได้ใช้ประโยชน์
            </p>
          </div>
          {/* 4 */}
          <div
          ...
          >
            ...
            <p className="text-left indent-6 text-xs md:text-sm">
              นักศึกษามีสิทธิ์สมัครเรียนวิชาการ (รด.) ต่อเนื่องปี 4 ปี 5 ได้
