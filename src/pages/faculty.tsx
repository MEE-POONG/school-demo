          ...
          <div className="max-w-8xl container relative mx-auto">
            <div className="flex flex-wrap items-center">
              <div className="ml-auto mr-auto w-full px-4 text-center lg:w-8/12">
                <p className="mb-6 font-medium text-xl md:text-4xl text-amber-600">
                  คณะและหลักสูตร
                </p>
              </div>
            </div>
        ...
        <div className="container mx-auto p-6 lg:p-10 lg:mt-24 mb-10 ">
          ...
          >
            <div className="h-auto md:w-[380px] flex-none bg-cover rounded-t md:rounded-t-none md:rounded-l text-center overflow-hidden">
              <img className="" src="/img/faculty/sFbus.png" alt="" />
            </div>
            <div className="mx-5 my-4">
              <p className="text-[#6CB4EE] text-[16px] md:text-xl lg:text-2xl ">
                {" "}
                คณะบริหารธุรกิจ{" "}
              </p>
              <p className="text-[#6CB4EE] text-[13px] md:text-md lg:text-xl mb-2">
                {" "}
          ...
          >
            <div className="h-auto md:w-[350px] flex-none bg-cover rounded-t md:rounded-t-none md:rounded-l text-center overflow-hidden">
              <img className="" src="/img/faculty/sFsci.png" alt="" />
            </div>
            <div className="mx-5 my-4">
              <p className="text-[#6CB4EE] text-[16px] md:text-xl lg:text-2xl">
                {" "}
              ...
              <ul className="list-disc list-inside text-black ml-3 text-[10px] md:text-[14px] lg:text-base">
                <li className="py-1 md:py-0.5 lg:py-2 ">
          ...
          >
            <div className=" md:w-[350px] md:h-[230px] flex-none bg-cover rounded-t md:rounded-t-none md:rounded-l text-center overflow-hidden">
              <img className="h-full" src="/img/faculty/Flib.png" alt="" />
            </div>
            <div className="mx-5 my-4">
              <p className="text-[#6CB4EE] text-[16px] md:text-xl lg:text-2xl ">
                {" "}
          ...
          >
            <div className="h-auto md:w-[350px] flex-none bg-cover rounded-t md:rounded-t-none md:rounded-l text-center overflow-hidden">
              <img className="" src="/img/faculty/sFeng.png" alt="" />
            </div>
            <div className="mx-5 my-4">
              <p className="text-[#6CB4EE] text-[16px] md:text-xl lg:text-2xl ">
                {" "}
          ...
          <div className="mx-3 mt-8">
            <div className="grid grid-cols-4 md:grid-cols-12 ">
              <div className="">
                <p className="text-[#1F306A] text-[12px] lg:text-[16px]">
                  หมายเหตุ :
                </p>
              </div>
              <div className="col-span-3 md:col-span-11">
                <p className="text-[#1F306A] text-[12px] lg:text-[16px]">
                  เสาร์-อาทิตย์ เรียนออนไลน์{" "}
                </p>
                <p className="text-[#1F306A] text-[12px] lg:text-[16px]">
                  เครื่องหมาย + แทนสาขาที่เปิดหลักสูตร วันเสาร์-อาทิตย์
                </p>
              </div>
            </div>
          </div>
