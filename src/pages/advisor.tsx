      ...
      <div className="container mx-auto px-5 md:px-14 my-10 lg:py-28">
        <div data-aos="fade-up">
          ...
          <p className="text-black text-xs md:text-base indent-8 py-5">
            ทีมอาจารย์ที่ปรึกษาคอยดูแลตลอดหลักสูตรการเรียน ด้วยประสบการณ์มากกว่า
            20 ปี ไม่ว่าจะติดปัญหาด้านการเงิน เวลา
            หรือระยะทางให้พวกเราทีมอาจารย์ที่ปรึกษาช่วยแก้ปัญหา
          ...
          <div className="grid grid-cols-3 gap-2 md:gap-28 ">
            <div className="shadow-lg p-5 rounded-md hover:animate-shake bg-white border-t-2 border-blue-300">
              <img
                ...
                alt=""
              />
              <p className="text-xs md:text-base text-blue-400 text-center">
                ดูแลตลอดหลักสูตร
              </p>
            </div>
        ...
        <div
          className="mt-10 md:mt-16 bg-blue-50/50 py-10 shadow-md"
          data-aos="fade-down"
        >
          <TeamAdvisor />
        </div>
