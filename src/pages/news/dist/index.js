...
function NewsPage() {
    ...
    fetch("/api/newsType")
      ...
      .then(function (data) {
        ...
        if (
          ...
          setSelectKey(
            data === null || data === void 0 ? void 0 : data.data[0].id
          );
        }
  ...
  react_1.useEffect(function () {
    fetch(
      ...
      .then(function (data) {
        setNewsArray(function (prevNews) {
        ...
        setCheckPage(
          data === null || data === void 0 ? void 0 : data.paginationInfo
        );
        setIsLoading(false);
      })
      ["catch"](function (error) {
        ...
        fetch(
          ...
          .then(function (data) {
            ...
            setCheckPage(function (prevCheckPage) {
              var newPaginationInfo =
                data === null || data === void 0
                  ? void 0
                  : data.paginationInfo[0];
              var indexToUpdate = prevCheckPage.findIndex(function (item) {
                return item.type === newPaginationInfo.type;
              });
              if (indexToUpdate !== -1) {
                var updatedCheckPage = __spreadArrays(
  ...
  var handleChangekeyword = function (search, page) {
    setParams(function (prevParams) {
      return __assign(__assign({}, prevParams), {
        keyword: search,
        page: page
      });
    });
  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      React.createElement(TitleText_1["default"], {
        titleText: "ข่าว & กิจกรรม",
        titleTextTo: "“พนมวันท์”"
      })
    )
  );
}
