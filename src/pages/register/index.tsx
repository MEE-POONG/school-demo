    ...
    return (
        <RootLayout>
            ...
            <div className='container mx-auto md:py-10 py-7'>
                <div className=' text-yellow-600 text-xl md:text-4xl drop-shadow-md mx-5 font-semibold mb-2'>สิ่งที่ควรรู้ก่อนสมัครเรียน </div>
                    <div className="grid grid-row-2 md:grid-flow-col gap-4 rounded-md bg-yellow-500 p-4 mx-5 h-[250px]">
