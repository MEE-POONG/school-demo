...
export default function Contact() {
    return (
        ...
        <div className="container mx-auto py-5 md:py-24  text-blue-900 ">
            ...
            <div className="grid grid-cols-3 gap-4 ml-3 md:ml-0">
                <div className="col-span-2">
                    <p className=" text-slate-600"><strong className="text-blue-900 mr-5 md:mr-10">ที่อยู่</strong>198 ถ.มิตรภาพ-จอหอ ต.บ้านโพธิ์ อ.เมือง จ.นครราชสีมา 30310</p>
                    <p className=" text-slate-600"><strong className="text-blue-900 mr-5 md:mr-10">โทร</strong>  044-955121-122</p>
                    <p className=" text-slate-600"><strong className="text-blue-900 mr-1 md:mr-10">แฟ็กซ์</strong> 044-955-120</p>
                    <p className=" text-slate-600"><strong className="text-blue-900 mr-5 md:mr-10">อีเมล</strong>phanomwanu@gmail.com</p>
                </div>
                <div className="">
                    <img className=" w-24 mx-auto md:w-36" src="/img/Logo_panomwan.png"/>
                </div>
