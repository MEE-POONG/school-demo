    ...
    <>
      <div className="font-poppins antialiased bg-[#1F306A] ">
        ...
        >
          ...
          <div
            id="sidebar"
            className="bg-white h-screen md:block shadow-xl px-3 w-[200px] md:w-60 lg:w-60 overflow-x-hidden transition-transform duration-300 ease-in-out"
            x-show="sidenav"
            ...
            <div className="space-y-6 md:space-y-10 mt-10">
              ...
              <div id="menu" className="flex flex-col space-y-2">
                ...
                >
                  ...
                  <span className="">สมัครเรียน</span>
                </a>
                {/* <a
                  href=""
                  className="text-sm font-medium text-gray-700 py-2 px-2 hover:bg-teal-500 hover:text-white hover:scale-105 rounded-md transition duration-150 ease-in-out"
